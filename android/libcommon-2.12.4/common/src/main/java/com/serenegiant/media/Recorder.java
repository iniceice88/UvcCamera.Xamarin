...
import static com.serenegiant.media.RecorderConsts.STATE_UNINITIALIZED;
import static com.serenegiant.media.RecorderConsts.STATE_INITIALIZED;
import static com.serenegiant.media.RecorderConsts.STATE_PREPARED;
import static com.serenegiant.media.RecorderConsts.STATE_STARTING;
import static com.serenegiant.media.RecorderConsts.STATE_STOPPING;
import static com.serenegiant.media.RecorderConsts.STATE_STARTED;
...
//	private static final boolean DEBUG = false;	// FIXME 実働時はfalseにすること
	...
	public void setMuxer(final IMuxer muxer) {
		if (!mReleased) {
			...
			synchronized(this) {
				mState = RecorderConsts.STATE_INITIALIZED;
			}
		}
	}
